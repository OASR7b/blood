...
<body>
    <div id="main" class="container">
        <div class="wrapper row">
            <div id="book-appointment-wizard" class="col-xs-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
                ...
                <?php
                    // ------------------------------------------------------
                    // FRAME TOP BAR <?php echo $company_name; ?
                    // ------------------------------------------------------ ?>

                <div id="header">
                    <span id="company-name"><img src="https://sr7b.org/wp-content/uploads/2018/01/d1bbc4c99b61973d2e1435c8f01e7b00248f1b65-2.png" alt="Southern Region Section 7B" height="55" width="332"></span>
  ...
  <center>For those who registered for the blood drive in April, your registration has been moved to August.<br>To cancel your appointment, see the email confirmation sent to you when you registered.</center>
                ...
                <div id="frame-footer">
					© 2019 Southern Region Section 7B | 
