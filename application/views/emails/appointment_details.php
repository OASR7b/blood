...
<body style="font: 13px arial, helvetica, tahoma;">
    <div class="email-container" style="width: 650px; border: 1px solid #eee;">
        <div id="header" style="background-color: #d63a42; border-bottom: 4px solid #fa5c60;
        ...
        <div id="content" style="padding: 10px 15px;">
            ...
            <table id="appointment-details">
                <tr>
                    <td class="label" style="padding: 3px;font-weight: bold;">Donation Type</td>
                    <td style="padding: 3px;">$appointment_service</td>
                </tr>
                <tr>
                    <td class="label" style="padding: 3px;font-weight: bold;">Event</td>
            ...
            <p>To cancel this blood donation, please click this link. Then, near the top of the page, click the cancel button.</p>
